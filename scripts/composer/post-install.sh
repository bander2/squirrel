...
if [ ! -f $DOCUMENTROOT/sites/default/settings.php ]
  then
    ...
    cat $SCRIPTROOT/settings.txt >> $DOCUMENTROOT/sites/default/settings.php
...
if [ ! -f $DOCUMENTROOT/sites/default/services.yml ]
  then
    ...
    cat $SCRIPTROOT/services.txt >> $DOCUMENTROOT/sites/default/services.yml
